...
import sys
import pygame
from configurations import derezzed_dir, frames, screen_size, lightcicle_size, LEFTblue_dir,RIGHTblue_dir,UPblue_dir,DOWNblue_dir,LEFTyellow_dir,RIGHTyellow_dir,UPyellow_dir,DOWNyellow_dir
